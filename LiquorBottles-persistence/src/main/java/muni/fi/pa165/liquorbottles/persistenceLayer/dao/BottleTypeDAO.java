...
/**
 * Interface BottleTypeDAO describes basic operations for returning desired
 * BottleType classes from database and also the CRUD operations to the
 * database.
 *
...
public interface BottleTypeDAO {
    ...
    /**
     * This method returns the bottle types from database specified by id
     * parameter
     *
    ...
    /**
     * This method returns the bottle types from database specified by alcohol
     * type parameter
     *
    ...
    /**
     * This method returns the bottle types from database specified by alcoholic
     * strength as parameter
     *
    ...
    /**
     * This method returns the bottle types from database specified by volume as
     * parameter
     *
    ...
    /**
     * This method returns the bottle types from database specified by producer
     * id as parameter
     *
    ...
    /**
     * This method returns the list of bottle types from database specified by
     * filter attributes
     *
     * @param producerID of bottle type in the database
     * @param name of bottle type in the database
     * @param alcType of bottle type in the database
     * @param power of bottle type in the database
     * @param volume of bottle type in the database
     * @return the bottle types produced by specific producer
     */
    List<BottleType> findByFilter(long producerID, String name, String alcType, int power, int volume);
