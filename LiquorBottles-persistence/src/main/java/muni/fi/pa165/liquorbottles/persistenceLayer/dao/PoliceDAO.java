...
/**
 * Interface PoliceDAO describes basic operations for returning desired Police
...
public interface PoliceDAO {
    ...
    /**
     * This method returns the Police from database specified by userName
     * parameter
     *
    ...
    /**
     * This method returns the Police from database specified by address
     * parameter
     *
    ...
    /**
     * This method returns list of the Police from database specified by address
     * parameter
     * @param name
     * @param address address of Police in the database
     * @return Police with address as parameter
     */
    List<Police> findByFilter(String name, String address);
