...
public interface StoreDAO {
    ...
    /**
     * This method returns the Store from database specified by address
     * parameter
     *
    ...
    /**
     * This method returns list of the Store from database specified by address, name
     * parameter
     * @param name
     * @param address 
     * @return the list of Store with address, name as parameter
     */
    List<Store> findByFilter(String name, String address);
