...
<table class="table">
    ...
    <tr>
        ...
        <td><s:text id="s2" class="form-control" name="store.address"/></td>
    </tr>
    <tr>
        <th><s:label for="s3" name="common.username"/></th>
        <td><s:text id="s3" class="form-control" name="store.username"/></td>
    </tr>
    <tr>
        <th><s:label for="s4" name="common.password"/></th>
        <td><s:text id="s4" class="form-control" name="store.password"/></td>
    </tr>
</table>
